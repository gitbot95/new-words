...
!(function (t, e) {
  ...
  class Je extends B {
    ...
    _getConfig(t) {
      if (
        'string' !=
          typeof (t = { ...Ge, ...U.getDataAttributes(this._element), ...('object' == typeof t && t ? t : {}) }).target &&
        r(t.target)
      ) {
        let { id: i } = t.target;
  ...
  class ti extends B {
    ...
    show() {
      ...
      if (P.trigger(this._element, 'show.bs.tab', { relatedTarget: e }).defaultPrevented || (null !== o && o.defaultPrevented))
        return;
    ...
    _activate(e, i, n) {
      const s = (
          !i || ('UL' !== i.nodeName && 'OL' !== i.nodeName) ? t.children(i, '.active') : t.find(':scope > li > .active', i)
        )[0],
